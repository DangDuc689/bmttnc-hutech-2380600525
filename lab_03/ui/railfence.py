...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(240, 20, 321, 41))
        font = QtGui.QFont()
        ...
        self.lb_plainText.setGeometry(QtCore.QRect(60, 130, 61, 16))
    ...
    def validate_encrypt(self):
        ...
        try:
            ...
            if key < 2:
                QMessageBox.warning(self.parent_window, "Lỗi Nhập Liệu", 
                                  "Key phải là số nguyên từ 2 trở lên!")
                self.txt_key.setFocus()
                return False
            if key >= len(plain_text):
                QMessageBox.warning(self.parent_window, "Lỗi Nhập Liệu", 
                                  "Khóa của RailFence phải nhỏ hơn độ dài của bản rõ!")
                self.txt_key.setFocus()
                return False
        except ValueError:
            QMessageBox.warning(self.parent_window, "Lỗi Nhập Liệu", 
    ...
    def validate_decrypt(self):
        ...
        try:
            ...
            if key >= len(cipher_text):
                QMessageBox.warning(self.parent_window, "Lỗi Nhập Liệu", 
                                  "Khóa của RailFence phải nhỏ hơn độ dài của bản mã!")
                self.txt_key.setFocus()
                return False
        except ValueError:
            QMessageBox.warning(self.parent_window, "Lỗi Nhập Liệu", 
